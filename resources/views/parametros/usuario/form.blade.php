...
<div class="form-group row">
    ...
    <div class="col-lg-3">
        <input type="text" name="usu_mail" class="form-usu_mail" id="usu_mail" placeholder="Correo Electronico"
...
<div class="form-group row">
    ...
    <div class="col-sm-12 col-lg-3">
        <select name="usu_empleado" id="usu_empleado" class="form-control select2" style="width:100%;" placeholder="Empleado">

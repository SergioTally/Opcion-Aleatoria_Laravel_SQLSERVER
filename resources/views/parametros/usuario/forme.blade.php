...
<div class="form-group row">
    <label for="usu_nombre" class="col-sm-12 col-lg-5 control-label text-sm-left text-lg-right requerido">Correo electronico</label>
    <div class="col-lg-3">
        <input type="text" name="usu_mail" class="form-control" id="usu_mail" placeholder="Nombre"
            value="{{old('usu_mail', $data->usu_mail ?? '')}}" required>
    </div>
</div>

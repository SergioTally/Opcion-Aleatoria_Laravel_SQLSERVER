...
class Menu extends Model
{
  ...
  protected $fillable = ['men_id','men_nombre', 'men_url', 'men_icono','men_deshabilitado','men_orden', 'men_padre'];
  ...
  {
          return $this->where('men_deshabilitado', false)->orderby('men_padre')
              ->orderby('men_orden')
              ->get()
              ->toArray();
  }

    ...
    public function run()
    {
        DB::table('menu')->insert([
            [
                ...
                'men_url' => 'cxc/ventas/reportes/emitidas',
                'men_orden' => 1,
                'men_icono' => 'fas fa-file-alt',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ], [
                ...
                'men_url' => 'cxc/ventas/reportes/articulos',
                'men_orden' => 2,
                ...
                'men_id'=>41,
                'men_padre' => 38,
                'men_nombre' => 'Integración de Clientes',
                'men_url' => 'cxc/ventas/reportes/clientes',
                'men_orden' => 3,
                'men_icono' => 'fas fa-user-tag',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ], [
                ...
                'men_url' => 'cxc/ventas/reportes/pendientes',
                'men_orden' => 4,
                'men_icono' => 'fas fa-file-invoice-dollar',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ], [
                ...
                'men_padre' => 45,
                'men_nombre' => 'Por Empresa',
                'men_url' => 'cxp/proveedores/empresa',
                'men_orden' => 2,
                'men_icono' => 'fas fa-address-card',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ], [
                ...
                'men_id'=>54,
                'men_padre' => 52,
                'men_nombre' => 'Integración de Proveedores',
                'men_url' => 'cxp/reportes/proveedores',
                'men_orden' => 2,
                'men_icono' => 'fas fa-user-tie',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ], [
                ...
                'men_url' => 'cxp/reportes/estadocuentaproveedores',
                'men_orden' => 3,
                'men_icono' => 'fas fa-file-invoice',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ], [
                ...
                'men_url' => 'cxp/reportes/pendientespago',
                'men_orden' => 4,
                'men_icono' => 'fas fa-file-invoice-dollar',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ], [
                ...
                'men_url' => 'activos/reporte/depreciacion',
                'men_orden' => 1,
                ...
                'men_url' => 'activos/reporte/amortizacion',
                'men_orden' => 2,
                'men_icono' => 'fas fa-table',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ], [
                ...
                'men_url' => 'activos/reporte/gastosactivos',
                'men_orden' => 3,
                ...
                'men_url' => 'contabilidad/polizamanual',
                'men_orden' => 1,
            ...
            [
                ...
                'men_url' => 'contabilidad/partida-cierre',
                'men_orden' => 2,
                ...
                'men_url' => 'contabilidad/regularizacionIva',
                'men_orden' => 3,
                ...
                'men_url' => 'contabilidad/regularizacion-relacionada',
                'men_orden' => 4,
                ...
                'men_url' => 'contabilidad/poliza-reserva-legal',
                'men_orden' => 5,
                ...
                'men_url' => 'contabilidad/calculo-ISR',
                'men_orden' => 6,
                ...
                'men_url' => 'contabilidad/libro-mayor',
                'men_orden' => 3,
                ...
                'men_url' => 'contabilidad/balance-comprobacion',
                'men_orden' => 4,
                ...
                'men_url' => 'contabilidad/balance-general',
                'men_orden' => 5,
                ...
                'men_url' => 'contabilidad/estado-resultado',
                'men_orden' => 6,
                ...
                'men_url' => 'contabilidad/flujo-efectivo',
                'men_orden' => 7,
                'men_icono' => 'fas fa-money-bill-alt',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ], [
                ...
                'men_url' => 'contabilidad/razon-financiera',
                'men_orden' => 8,
                ...
                'men_url' => 'contabilidad/reportes/libro-compras',
                'men_orden' => 1,
                'men_icono' => 'fas fa-file-download',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ], [
                ...
                'men_url' => 'contabilidad/reportes/libro-ventas',
                'men_orden' => 2,
                'men_icono' => 'fas fa-file-upload',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ], [
                ...
                'men_url' => 'contabilidad/reportes/formulario-IVA',
                'men_orden' => 3,
                'men_icono' => 'fas fa-file-alt',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ], [
                ...
                'men_url' => 'contabilidad/reportes/formulario-retencion',
                'men_orden' => 4,
                'men_icono' => 'far fa-file-alt',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ], [
                ...
                'men_url' => 'contabilidad/reportes/formulario-ISO',
                'men_orden' => 5,
                'men_icono' => 'fas fa-file',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ], [
                ...
                'men_url' => 'contabilidad/reportes/formulario-trimestral',
                'men_orden' => 6,
                ...
                'men_url' => 'contabilidad/reportes/formulario-anual',
                'men_orden' => 7,
